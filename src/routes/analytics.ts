...
const SnapshotSchema = z.object({
  ...
  ttViews: z.number().nullable().optional(),
  ttLikes: z.number().nullable().optional(),
  ttFollowerGrowth: z.number().nullable().optional(),
  ttEngagementRate: z.number().min(0).max(1).nullable().optional(),
...
analyticsRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const snapshot = await recordWeeklySnapshot({
      ...
      ttViews: body.ttViews ?? null,
      ttLikes: body.ttLikes ?? null,
      ttFollowerGrowth: body.ttFollowerGrowth ?? null,
      ttEngagementRate: body.ttEngagementRate ?? null,
